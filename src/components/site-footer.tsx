  ...
  return (
    <footer className="w-full border-t border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-950">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 py-16 sm:px-8 md:grid-cols-3">
        <div>
          <h4 className="mb-6 font-headline text-lg font-bold text-slate-900 dark:text-white">
        ...
        <div>
          <h5 className="mb-6 font-headline text-sm font-semibold tracking-widest text-slate-900 uppercase dark:text-white">
            Información
          </h5>
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 border-t border-slate-200 px-4 py-8 sm:px-8 md:flex-row dark:border-slate-800">
